(function(global, factory) {
    ...
    var Auth0Client = function() {
        ...
        Auth0Client.prototype._authorizeUrl = function(authorizeOptions, authorizePath) {
            if (authorizePath === void 0) {
                authorizePath = DEFAULT_AUTHORIZE_PATH;
            }
        ...
        Auth0Client.prototype.buildAuthorizeUrl = function(options) {
            ...
            return __awaiter(this, void 0, void 0, (function() {
                var redirect_uri, appState, authorizeOptions, stateIn, nonceIn, code_verifier, code_challengeBuffer, code_challenge, fragment, params, authPath, url, organizationId;
                return __generator(this, (function(_a) {
                    switch (_a.label) {
                      case 0:
                      ...
                      case 1:
                        ...
                        authPath = options.authorizePath || this.options.authorizePath;
                        url = this._authorizeUrl(params, authPath);
        ...
        Auth0Client.prototype.loginWithPopup = function(options, config) {
            return __awaiter(this, void 0, void 0, (function() {
                var authorizeOptions, stateIn, nonceIn, code_verifier, code_challengeBuffer, code_challenge, params, authPath, url, codeResult, authResult, organizationId, decodedToken, cacheEntry;
                return __generator(this, (function(_a) {
                    switch (_a.label) {
                      case 0:
                        options = options || {};
        ...
        Auth0Client.prototype._getTokenFromIFrame = function(options) {
            return __awaiter(this, void 0, void 0, (function() {
                var stateIn, nonceIn, code_verifier, code_challengeBuffer, code_challenge, withoutClientOptions, params, authPath, orgIdHint, url, authorizeTimeout, codeResult, scope, audience, customOptions, tokenResult, decodedToken, e_1;
                return __generator(this, (function(_a) {
                    switch (_a.label) {
                      case 0:
                        stateIn = encode(createRandomString());
                      ...
                      case 3:
                        ...
                        scope = options.scope, audience = options.audience, options.redirect_uri, options.ignoreCache, 
                        options.timeoutInSeconds, options.detailedResponse, customOptions = __rest(options, [ "scope", "audience", "redirect_uri", "ignoreCache", "timeoutInSeconds", "detailedResponse" ]);
                ...
                return __generator(this, (function(_a) {
                    switch (_a.label) {
                      ...
                      case 4:
                        ...
                        scope = options.scope, audience = options.audience, options.ignoreCache, options.timeoutInSeconds, 
                        options.detailedResponse, customOptions = __rest(options, [ "scope", "audience", "ignoreCache", "timeoutInSeconds", "detailedResponse" ]);
